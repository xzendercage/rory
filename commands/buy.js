...
module.exports = {
    ...
    run: async (bot, message, args) => {
		...
		.setDescription('<a:no:863733318809812992> **You are banned from using this section | Reason : Abuse\n[Contact](https://instagram.com/ixc.xzn) with the [owner of the bot](https://discord.com/users/491158509803536384) to appeal a permanent ban**')
        ...
        let Embed = new MessageEmbed()
            .setColor(colors.main)
            .setDescription(`**You need 25,000 <:RoRy_Coin:867679208855437333> to purchase Shovel**`);
        ...
        if (args.join(' ').toLocaleLowerCase() == 'shovel') {
            ...
            let Embed2 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Shovel For 25,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed3 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 25,000 <:RoRy_Coin:867679208855437333> to purchase Fishing Pole**`);
            ...
            let Embed4 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Fishing Pole For 25000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed5 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 50,000 <:RoRy_Coin:867679208855437333> to purchase Headphone**`);
            ...
            let Embed6 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Headphone For 50,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed7 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 120,000 <:RoRy_Coin:867679208855437333> to purchase Cell Phone**`)
            ...
            let Embed8 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Cell Phone For 120,000 <:RoRy_Coin:867679208855437333>**`);
            ...
            let Embed9 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 200,000 <:RoRy_Coin:867679208855437333> to purchase laptop**`)
            ...
            let Embed10 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Laptop For 200,000 <:RoRy_Coin:867679208855437333>**`);
            ...
            let Embed11 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 1,000,000 <:RoRy_Coin:867679208855437333> to purchase DB Coin**`);
            ...
            let Embed12 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased DB Coin For 1,000,000 <:RoRy_Coin:867679208855437333>\nSend amount of coins you need to DevEvil#8745 to be added to your account**`);
            ...
            let Embed13 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 350,000 <:RoRy_Coin:867679208855437333> to purchase Pistol**`);
            ...
            let Embed14 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Pistol For 350,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed15 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 650,000 <:RoRy_Coin:867679208855437333> to purchase Rifle**`);
            ...
            let Embed16 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Rifle For 650,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed17 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 700,000 <:RoRy_Coin:867679208855437333> to purchase Sniper**`);
            ...
            let Embed18 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Sniper For 700,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed20 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 700,000 <:RoRy_Coin:867679208855437333> to purchase Shotgun**`);
            ...
            let Embed21 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Shotgun For 700,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed22 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 1,500,000 <:RoRy_Coin:867679208855437333> to purchase Ghost**`);
            ...
            let Embed23 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Ghost For 1,500,000 <:RoRy_Coin:867679208855437333>**`);
            ...
            let Embed24 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 2,500,000 <:RoRy_Coin:867679208855437333> to purchase Ninja**`);
            ...
            let Embed25 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Ninja For 2,500,000 <:RoRy_Coin:867679208855437333>**`);
            ...
            let Embed26 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 5,000,000 <:RoRy_Coin:867679208855437333> to purchase Mind Reading**`);
            ...
            let Embed27 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Mind Reading For 5,000,000 <:RoRy_Coin:867679208855437333>**`);
            ...
            let Embed28 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 15,000,000 <:RoRy_Coin:867679208855437333> to purchase Invisible**`);
            ...
            let Embed29 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Invisible For 15,000,000 <:RoRy_Coin:867679208855437333>**`);
            ...
            let Embed30 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 200,000 <:RoRy_Coin:867679208855437333> to purchase Copper**`);
            ...
            let Embed31 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Copper For 200,000 <:RoRy_Coin:867679208855437333>**`);
            ...
            let Embed32 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 1,000,000 <:RoRy_Coin:867679208855437333> to purchase Bronze**`);
            ...
            let Embed33 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Bronze For 1,000,000 <:RoRy_Coin:867679208855437333>**`);
            ...
            let Embed34 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 2,000,000 <:RoRy_Coin:867679208855437333> to purchase Silver**`);
            ...
            let Embed35 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Silver For 2,000,000 <:RoRy_Coin:867679208855437333>**`);
            ...
            let Embed36 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 3,000,000 <:RoRy_Coin:867679208855437333> to purchase Gold**`);
            ...
            let Embed37 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Gold For 3,000,000 <:RoRy_Coin:867679208855437333>**`);
            ...
            let Embed38 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 5,000,000 <:RoRy_Coin:867679208855437333> to purchase Diamond**`);
            ...
            let Embed39 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Diamond For 5,000,000 <:RoRy_Coin:867679208855437333>**`);
            ...
            let Embed40 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 10,000,000 <:RoRy_Coin:867679208855437333> to purchase Immortal**`);
            ...
            let Embed41 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Immortal For 10,000,000 <:RoRy_Coin:867679208855437333>**`);
            ...
            let Embed43 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 1,700 <:RoRy_Coin:867679208855437333> to purchase Turtle**`);
            ...
            let Embed44 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Turtle For 1,700 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed45 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 2,000 <:RoRy_Coin:867679208855437333> to purchase Bird**`);
            ...
            let Embed46 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Bird For 2,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed47 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 5,000 <:RoRy_Coin:867679208855437333> to purchase Cat**`);
            ...
            let Embed48 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Cat For 5,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed49 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 5,500 <:RoRy_Coin:867679208855437333> to purchase Dog**`);
            ...
            let Embed50 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Dog For 5,500 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed51 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 10,000 <:RoRy_Coin:867679208855437333> to purchase Snake**`);
            ...
            let Embed52 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Snake For 10,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed53 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 3,000,000 <:RoRy_Coin:867679208855437333> to purchase Tesla**`);
            ...
            let Embed54 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Tesla For 3,000,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed55 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 5,000,000 <:RoRy_Coin:867679208855437333> to purchase Ferrari**`);
            ...
            let Embed56 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Ferrari For 5,000,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed57 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 8,000,000 <:RoRy_Coin:867679208855437333> to purchase Bugatti**`);
            ...
            let Embed58 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Bugatti For 8,000,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed59 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 12,000,000 <:RoRy_Coin:867679208855437333> to purchase Lamborghini**`);
            ...
            let Embed60 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Lamborghini For 12,000,00 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed61 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 15,000,000 <:RoRy_Coin:867679208855437333> to purchase Mercedes-Benz**`);
            ...
            let Embed62 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Mercedes-Benz For 15,000,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed63 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 20,000,000 <:RoRy_Coin:867679208855437333> to purchase Rolls-Royce**`);
            ...
            let Embed64 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Rolls-Royce For 20,000,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed65 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 10,000,000 <:RoRy_Coin:867679208855437333> to purchase Apartment**`);
            ...
            let Embed66 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Apartment For 10,000,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed67 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 15,000,000 <:RoRy_Coin:867679208855437333> to purchase Villa**`);
            ...
            let Embed68 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Villa For 15,000,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed69 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 20,000,000 <:RoRy_Coin:867679208855437333> to purchase Ocean View**`);
            ...
            let Embed70 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Ocean View House For 20,000,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed71 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 30,000,000 <:RoRy_Coin:867679208855437333> to purchase Mansion**`);
            ...
            let Embed72 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Mansion For 30,000,000 <:RoRy_Coin:867679208855437333>**`)
            ...
            let Embed73 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**You need 50,000,000 <:RoRy_Coin:867679208855437333> to purchase Castle**`);
            ...
            let Embed74 = new MessageEmbed()
                .setColor(colors.main)
                .setDescription(`**Purchased Castle For 50,000,000 <:RoRy_Coin:867679208855437333>**`)
