...
module.exports = {
    name: "rps",
	description: 'Play a game of rock–paper–scissors against RoRy',
    ...
    else if (botChoice > userChoice || botChoice === 0 && userChoice === 2) result = '**RoRy wins <a:CupGif:788458892497125436>**';
    else result = `**${message.member.displayName} wins <a:CupGif:788458892497125436>**`;
    const embed = new Discord.MessageEmbed()
      .setTitle(`${message.member.displayName} vs. RoRy`)
      .addField('Your Choice:', res[userChoice], true)
      .addField('RoRy\'s Choice', res[botChoice], true)
